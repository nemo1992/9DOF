...
# Main scene
scene=display(title="9DOF IMU ROV")
...
scene2 = display(title='9DOF IMU ROV',x=0, y=0, width=500, height=200,center=(0,0,0), background=(0,0,0))
scene2.range=(1,1,1)
scene.width=500
scene.y=200
...
# labels
label(pos=(0,0,0.8),text="9DOF IMU ROV",box=0,opacity=0)
