...
#create objects
text(text='Left',align='center',height=0.02, depth=-0.1, pos=vector(-0.1,-0.12,0), color=color.green)
text(text='Right',align='center',height=0.02, depth=-0.1, pos=vector(0.1,-0.12,0), color=color.green)
